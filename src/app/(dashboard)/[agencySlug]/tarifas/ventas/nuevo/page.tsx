...
export default async function NuevaTarifaVentaPage({
  params,
}: {
  ...
  const [providers, pensionRegimes, roomTypes, foodTypes, excursionCodes, transferSegments, ticketSegments] =
    await Promise.all([
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-4">
      <div>
        <h1 className="text-2xl font-bold">Nueva Tarifa de Venta</h1>
        <p className="text-muted-foreground text-sm">Tarifa de venta al cliente para un tipo de servicio</p>
      </div>
      <CostTariffForm
        mode="tariff"
        agencyId={agency.id}
